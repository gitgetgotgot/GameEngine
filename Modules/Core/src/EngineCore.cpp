...
#include <Objects/ComponentSystems/TransformSystem.h>
#include <Objects/ComponentSystems/CameraSystem.h>
#include <UI/UIComponentSystems/CanvasSystem.h>
#include <UI/UIComponentSystems/ImageSystem.h>
#include <UI/UIComponentSystems/ButtonSystem.h>
#include <UI/UIComponentSystems/SDF_TextSystem.h>
...
void EngineCore::main_init() {
	...
	std::string projectName("TemporaryProjectsFolder/Project999");
	//ProjectManager::get_Instance()->CreateEmptyProject(projectName);
	ProjectManager::get_Instance()->LoadProject(projectName);
	std::string sceneName = "Arena";
	//ProjectManager::get_Instance()->AddNewScene(sceneName);
	//ProjectManager::get_Instance()->SaveProject();
}
