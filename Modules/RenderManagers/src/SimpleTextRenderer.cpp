#include <RenderManagers/SimpleTextRenderer.h>
...
SimpleTextRenderer::SimpleTextRenderer(std::unique_ptr<Engine::Graphics::RendererInterface>& renderer) {
	...
	shader = renderer->createShader(ShaderDesc("", "Resources/Shaders/OpenGL/Basic Text Vert.glsl", "Resources/Shaders/OpenGL/Basic Text Frag.glsl"));
	shader->bind();
